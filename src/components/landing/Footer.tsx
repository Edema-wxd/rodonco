        ...
        <div className="grid grid-cols-2 gap-12 sm:grid-cols-3">
          ...
          <div className="col-span-2 flex flex-col gap-6 sm:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/rodoandco?igsh=MXRpNzE0eDd3MmR6Mg%3D%3D&utm_source=qr"
                target="_blank"
              ...
              <a
                href="https://x.com/rodoandco?s=11"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/company/rodo-co/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="opacity-80 transition-opacity hover:opacity-100"
              ...
              <a
                href="https://wa.me/2348086451542"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="opacity-80 transition-opacity hover:opacity-100"
