...
describe("AdminSidebar [D-01, D-04, D-22]", () => {
  ...
  it("D-01: renders nav links with the correct hrefs", () => {
    render(<AdminSidebar adminEmail="admin@rodo.com" pendingBadge={null} abandonedBadge={null} />);
  ...
  it("D-04: active link gets aria-current='page'", () => {
    ...
    render(<AdminSidebar adminEmail="a@b.c" pendingBadge={null} abandonedBadge={null} />);
  ...
  it("shows pending badge when slot has content", () => {
    render(<AdminSidebar adminEmail="a@b.c" pendingBadge={5} abandonedBadge={null} />);
    expect(screen.getByText("5")).toBeTruthy();
  });

  it("hides pending badge when slot is empty", () => {
    render(<AdminSidebar adminEmail="a@b.c" pendingBadge={null} abandonedBadge={null} />);
